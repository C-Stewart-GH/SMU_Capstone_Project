...
directory = os.fsencode(
    "C:\\Users\\mmaze\\Desktop\\Capstone\\New_Data\\new_data_files\\"
)
file_path_holder = []
...
clean_vball_data[0]["divisions"][0]['matches'][0] #Added roundNumber, matchNumber, matchWinner
clean_vball_data[0]["divisions"][0]['matches'][0]['games'][0] #Added gameNumber, winLoss
clean_vball_data[0]["divisions"][0]['matches'][0]['playerProfileIds']
...
with bz2.BZ2File('Pickle_Files/new_vball_game_data.pbz2', 'wb') as file:
